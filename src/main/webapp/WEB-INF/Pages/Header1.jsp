...
<body>
	...
	<nav class="navbar navbar-expand-xl navbar-dark"
		style="background-color: rgb(227, 242, 253,0.8);height:60px; ">
		<a href=""> <img
		...
		<button class="navbar-toggler" type="button" data-toggle="collapse"
			...
			aria-controls="collapsibleNavbar" aria-expanded="false"
		...
		<div class="collapse navbar-collapse" id="collapsiblenavbar">
			...
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="font-size: 14px;">
				...
				<c:if test="${not empty sessionScope.user}">
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/User/AddUser"/>"><i
							class="fas fa-user" style="color: #0f6810;"></i> 
					<span style="color:	#FF4500;"><s:message code="label.adduser" /></span></a>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Student/AddStudent"/>"><i
							class="fa fa-user-graduate" style="color: #0f6810;"></i> <span
							style="color: #8A2BE2;"><s:message code="label.addstudent" />
						</span></a></li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/College/AddCollege"/>"><i
							...
							style="color: #8A2BE2;"><s:message code="label.addcollege" /></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Faculty/AddFaculty"/>"><i
							...
							style="color: #8A2BE2;"><s:message code="label.addfaculty" /></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Subject/AddSubject"/>"><i
							...
							style="color: #8A2BE2;"><s:message code="label.addsubject" /></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Role/AddRole"/>"><i
							...
							style="color: #8A2BE2;"><s:message code="label.addrole" /></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Course/AddCourse"/>"><i
							...
							style="color: #8A2BE2;"><s:message code="label.addcourse" /></span></a>
					</li>
					...
					<li class="nav-item dropdown text-nowrap"><a
						...
						role="button" aria-haspopup="true" aria-expanded="false"> <span><i
							...
							style="color: 8A2BE2; font-size: 14px;"><s:message
		...
		<div class="navbar nav-item dropdown text-nowrap dropdown-menu-left">
			...
			<div class="dropdown-menu dropdown-menu-right" 
			     style="font-size: 15px;left:-10px;background-color: e6f7ff">
				...
				<c:if test="${not empty sessionScope.user}">
					...
					<a class="dropdown-item"
						...
						class='fa fa-user-circle' style="color: #0f6810;"></i><span
						style="color: #3fcc41;"> <span style="color: #3fcc41;"><s:message
					...
					<a class="dropdown-item"
						...
						<span style="color: #3fcc41;"><span style="color: #3fcc41;"><s:message

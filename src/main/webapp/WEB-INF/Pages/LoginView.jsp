...
<article class="card-body">
	...
	<h4 class="card-title text-center mb-2" style="color: #C71585;"><s:message code="label.login"></s:message></h4>
  ...
  <b>${error}</b>
    ...
    <s:message code="label.email"></s:message><span style="color: red">*</span>
    ...
    <s:message code="label.password"></s:message><span style="color: red">*</span>
	<div class="input-group">
	<div class="input-group-prepend">
	...
	<div align="left"> <font style="color: red"><sf:errors path="password"/></font></div></div>
     ...
     <button type="submit" name="operation"  value="SignIn"  class="btn btn-primary button2" title="this is for login">
     <i  class='fa fa-paper-plane' style="color:" aria-hidden="true"></i> <s:message code="label.login"></s:message></button>
	
	<a href="<c:url value="/Registration"></c:url>" class="btn btn-primary button2"><s:message code="label.userRegistration"></s:message></a>

...
<c:choose>
<c:when test="${form.id==0}"><h4 class="card-title text-center" style="color: #C71585;"><s:message code="label.addrole" /></h4></c:when>
<c:otherwise><h4 class="card-title text-center" style="color: #C71585;"><s:message code="label.updaterole"></s:message></h4>
</c:otherwise>
</c:choose> 
	...
	<c:choose>
              	<c:when test="${form.id==0}">
								<button type="submit" name="operation"
									style= "float:left; width: 80px; margin-left:40px;"
								...
								<button type="submit" name="operation"
									style="width: 90px; margin-left:70px;" value="reset"
							...
							<c:otherwise>
								...
								<button type="submit" name="operation"
									style="width: 100px; margin-left:110px;" value="Cancel"
									class="btn btn-primary btn-block button2">

...
<div class="row d-flex justify-content-center h-100">
	...
	<center>
      <h4 style="color: white;">MARKSHEETMERITLIST</h4>
    </center>
		<div class="card card-table">
			<h3 class="w-100 text-center under-over-line" style="color: white;">
				...
				<div class="row p-2 d-flex justify-content-center">
					<div class="col-lg-2">
								<a class="btn btn-info btn-block btn-round w-100" target="blank" href='<c:url value="/ctl/Jasper"></c:url>'><i class="fa fa-print" aria-hidden="true"></i> Print</a>
					</div>
				</div>

...
<%@page import="in.co.rays.proj0.controller.MarksheetCtl"%>
    
<html>
<head>
<style type="text/css">
 body {
	background-image: url("/project_0/resources/img/b5.jpg");
...
<sf:form method="post" commandName="form" name="frm">
     ...
     <div class="row">
				...
				<label><font style="color: white;"><strong><s:message code="label.rollNo"></s:message> :~</strong></font>
						</label>
				</div>
   ...
   <fmt:formatNumber value="${result/3}" minFractionDigits="2" maxFractionDigits="2" var="per"></fmt:formatNumber>
       ...
       <table class="table table-hover" border="2">
			...
			<tr class="">
		        ...
		        <td colspan=""  class="text-white bg-info"><b><s:message code="label.rollNo" ></s:message>:</b><b>${form.rollNo}</b></td>
                <td colspan="2" class="bg-info text-white" ><b><s:message code="label.name"></s:message>: </b>${form.name}</td>
		
			<td colspan="3" align="center" class="bg-info text-white"><s:message code="label.obtained"/></td>
						</tr>
						...
						<tr bgcolor="" class="bg-info text-white" >

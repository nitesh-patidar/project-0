				...
				<div class="row p-2 d-flex justify-content-center">
					...
					<div class="col-lg-3">
						<div class="row">
							...
							<div class="col-6">
								<button type="submit"
									class="btn btn-outline-warning btn-block btn-round w-100"  name="operation"
								...
								<tr>
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Role/AddRole?id=" />
              							<a class="btn btn-outline-success" style="border-color: #8A2BE2; color: #8A2BE2;" 
              							   name="operation" href="${editUrl}${role.id}"><i class="fa fa-edit" aria-hidden="true"></i></a>
									</td>
								</tr>
							</c:forEach>
							</tbody>

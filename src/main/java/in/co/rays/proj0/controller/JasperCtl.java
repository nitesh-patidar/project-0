package in.co.rays.proj0.controller;
...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("F:\\Spring\\project_0\\src\\main\\webapp\\WEB-INF\\Pages\\Cherry.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("F:\\Spring\\project_0\\src\\main\\webapp\\WEB-INF\\Pages\\Cherry.jrxml");

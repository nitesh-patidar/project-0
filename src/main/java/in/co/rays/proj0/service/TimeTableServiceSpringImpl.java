...
private static Logger log = Logger.getLogger(TimeTableServiceSpringImpl.class);
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.TimeTableServiceInt#add(in.co.rays.proj0.dto.TimeTableDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.TimeTableServiceInt#update(in.co.rays.proj0.dto.TimeTableDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.TimeTableServiceInt#delete(long)
	 */
	@Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.TimeTableServiceInt#findByPk(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.TimeTableServiceInt#search(in.co.rays.proj0.dto.TimeTableDTO, int, int)
	 */
	@Transactional( readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.TimeTableServiceInt#search(in.co.rays.proj0.dto.TimeTableDTO)
	 */
	@Transactional( readOnly = false)

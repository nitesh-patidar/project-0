...
public class RoleServiceSpringImpl implements RoleServiceInt{
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#add(in.co.rays.proj0.dto.RoleDTO)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#update(in.co.rays.proj0.dto.RoleDTO)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#delete(long)
     */
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#findByName(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#findById(long)
     */
    @Transactional(readOnly = true)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#search(in.co.rays.proj0.dto.RoleDTO, int, int)
     */
    @Transactional(readOnly = true)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.RoleServiceInt#search(in.co.rays.proj0.dto.RoleDTO)
     */
    @Transactional(readOnly = true)

...
public class MarksheetServiceSpringImpl implements MarksheetServiceInt{
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#add(in.co.rays.proj0.dto.MarksheetDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#update(in.co.rays.proj0.dto.MarksheetDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#delete(long)
	 */
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#findByRollNumber(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#findById(long)
	 */
	@Transactional(readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#search(in.co.rays.proj0.dto.MarksheetDTO, int, int)
	 */
	@Transactional(readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#search(in.co.rays.proj0.dto.MarksheetDTO)
	 */
	@Transactional(readOnly = false)
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.service.MarksheetServiceInt#getMeritList(int, int)
	 */
	@Transactional(readOnly = false)

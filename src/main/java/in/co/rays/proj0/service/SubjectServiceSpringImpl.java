...
public class SubjectServiceSpringImpl implements SubjectServiceInt {
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#add(in.co.rays.proj0.dto.SubjectDTO)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#update(in.co.rays.proj0.dto.SubjectDTO)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#delete(long)
     */
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#findByName(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#findById(long)
     */
    @Transactional( readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#search(in.co.rays.proj0.dto.SubjectDTO, int, int)
     */
    @Transactional( readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.proj0.service.SubjectServiceInt#search(in.co.rays.proj0.dto.SubjectDTO)
     */
    @Transactional( readOnly = false)

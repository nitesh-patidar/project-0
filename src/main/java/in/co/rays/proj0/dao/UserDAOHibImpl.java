...
public class UserDAOHibImpl implements UserDAOInt{
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#add(in.co.rays.proj0.dto.UserDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#update(in.co.rays.proj0.dto.UserDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#findByLogin(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#search(in.co.rays.proj0.dto.UserDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.proj0.dao.UserDAOInt#search(in.co.rays.proj0.dto.UserDTO)
	 */
